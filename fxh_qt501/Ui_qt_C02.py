...
class Ui_qt_c02(object):
    def setupUi(self, qt_c02):
        ...
        self.btn_countDown = QtWidgets.QPushButton(qt_c02)
        self.btn_countDown.setGeometry(QtCore.QRect(70, 190, 121, 23))
        self.btn_countDown.setObjectName("btn_countDown")
        self.lbl_digit = QtWidgets.QLabel(qt_c02)
        self.lbl_digit.setGeometry(QtCore.QRect(290, 130, 191, 121))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(36)
        font.setBold(False)
        font.setWeight(50)
        self.lbl_digit.setFont(font)
    ...
    def retranslateUi(self, qt_c02):
        ...
        self.btn_countDown.setText(_translate("qt_c02", "倒计时"))
        self.lbl_digit.setText(_translate("qt_c02", "TextLabel"))
